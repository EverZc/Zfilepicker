...
import me.pandazhang.filepicker.adapter.VideoPickAdapter;
...
public class VideoPickActivityPicker extends PickerBaseActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        switch (requestCode) {
            case FilePicker.REQUEST_CODE_TAKE_VIDEO:
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_done) {
            ...
            intent.putParcelableArrayListExtra(FilePicker.RESULT_PICK_VIDEO, mSelectedList);
