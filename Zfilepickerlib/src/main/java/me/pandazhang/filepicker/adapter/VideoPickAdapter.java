...
import me.pandazhang.filepicker.activity.VideoPickActivityPicker;
import me.pandazhang.filepicker.filter.entity.VideoFile;

import static android.os.Environment.DIRECTORY_DCIM;
import static me.pandazhang.filepicker.FilePicker.REQUEST_CODE_TAKE_VIDEO;
...
public class VideoPickAdapter extends BaseAdapter<VideoFile, VideoPickAdapter.VideoPickViewHolder> {
    ...
    public VideoPickAdapter.VideoPickViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (params != null) {
            ...
            params.height = width / VideoPickActivityPicker.COLUMN_NUMBER;
        }
